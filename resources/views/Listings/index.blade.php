...
<div class="container mx-auto py-6">
    ...
    <h1 class="text-3xl font-bold mb-6">Todos los Listings</h1>
    ...
    @foreach ($listings as $listing)
        <div class="border rounded-lg p-4 mb-4 shadow hover:shadow-lg transition">
            ...
            <p class="text-gray-600 mb-2">
                <strong>Publicado por:</strong> {{ $listing->user->name }}
            </p>
    ...
    @if($listings->isEmpty())
        <p class="text-gray-600">No hay listings disponibles.</p>
    @endif
